...
* http://techvalleyprojects.blogspot.fr/2012/06/arduino-control-escmotor-tutorial.html
*
* http://techvalleyprojects.blogspot.fr/2012/06/arduino-control-escmotor-arduino-code.html
*/
...
void setup()
{
  ...
  Serial.println("SMT TurboSpeed 1000/R spec : ");
  Serial.println("59 -> 0 : Reverse (min to max)");
  Serial.println("60 : Neutral (stopped)");
  Serial.println("61 -> 180 : Forward (min to max)");
}
